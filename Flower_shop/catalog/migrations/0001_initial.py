    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=30, verbose_name='Пользователь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default_flower.jpeg', upload_to='catalog/img/', verbose_name='Изображение')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flowers', to='catalog.category', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Цветок',
